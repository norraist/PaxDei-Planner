...
Usage:
  python utils/generate_profile.py --static source_data/staticdatabundle/StaticDataBundle.json --loc source_data/localisation/localisation_en.json --out config/player_profile.json [--base existing_profile.json]
"""
